...
namespace SikkerDigitalPost.Klient.XmlValidering
{
    internal abstract class XmlValidering
    {
        ...
        private const string XsdMappe = @"C:\Prosjekt\DigiPost\sikker-digital-post-net-klient\SikkerDigitalPost.Klient\XmlValidering\xsd";
        ...
        {
            return Path.Combine(XsdMappe, filnavn);
        }
    }
}
